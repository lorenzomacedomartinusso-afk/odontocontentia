...
const LandingPage: React.FC<{ onLogin: () => void }> = ({ onLogin }) => (
  <div className="min-h-screen flex flex-col relative overflow-hidden bg-zinc-950">
    ...
    <div className="fixed bottom-[-10%] right-[-10%] w-[700px] h-[700px] bg-emerald-600/12 rounded-full blur-[180px] pointer-events-none z-0" />
    <div className="fixed top-[30%] right-[20%] w-[400px] h-[400px] bg-cyan-500/8 rounded-full blur-[120px] pointer-events-none z-0" />
