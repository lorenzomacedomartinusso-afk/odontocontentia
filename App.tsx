  ...
  <div className="min-h-screen flex flex-col relative overflow-hidden bg-zinc-950">
    ...
    <header className="flex justify-between items-center p-4 md:px-20 lg:px-28 md:py-8 w-full z-10 relative">
      <div className="flex items-center gap-2">
        <Sparkles className="w-10 h-10 md:w-12 md:h-12 text-brand-teal shrink-0" />
    ...
    <main className="flex-1 flex flex-col w-full z-10 relative">
      ...
      <section className="py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-16">
            <Reveal>
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">A diferença entre um post que 'curtem' e um vídeo que <span className="text-brand-teal">'agendam'.</span></h2>
  ...
  return (
    <div className="flex flex-col h-full w-full max-w-[98%] xl:max-w-[95%] 2xl:max-w-[92%] mx-auto">
      ...
      <div className="flex-1 min-h-0 flex flex-col relative overflow-hidden">
        {loading && (
          <div className="fixed top-20 left-0 right-0 bottom-0 z-50 flex flex-col items-center justify-center text-center p-4 bg-black/60 backdrop-blur-md">
              ...
              <div className="w-full">
                <div className="flex flex-col items-center justify-center gap-3 mb-8 max-w-5xl mx-auto w-full">
                  <div className="flex flex-col md:flex-row items-center justify-center w-full gap-3 md:gap-4">
                    ...
                    <h2 className="text-2xl min-[350px]:text-3xl min-[400px]:text-4xl sm:text-4xl md:text-5xl font-bold text-white leading-tight md:whitespace-nowrap text-center md:text-left tracking-tighter md:tracking-normal w-full md:w-auto px-1">
  ...
  return (
    <div className="h-screen flex flex-col bg-brand-black text-zinc-200 relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative w-full pb-20 z-10">
        <header className="h-20 border-b border-zinc-800 flex items-center justify-between px-4 md:px-8 bg-brand-surface/90 md:bg-brand-black/50 backdrop-blur-xl md:backdrop-blur-md z-30 shrink-0">
          <div className="flex items-center gap-3">
